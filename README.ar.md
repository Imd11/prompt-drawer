...
Prompt Drawer هو مكتبة prompts محلية لسطح المكتب، مصممة لـ Codex وCursor وسطر الأوامر (CLI). يحتفظ التطبيق بزر عائم قرب حقل الإدخال النشط، ويفتح لوحة prompts مدمجة، ثم يدرج prompt الذي تختاره حيث تعمل.
