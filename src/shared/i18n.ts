...
export const messages = {
  "zh-CN": {
    ...
    manager: {
      ...
      promptLibraryLocal: "提示词库：使用 App 内部副本",
      promptLibraryLinked: (fileName: string) => `提示词库：已链接 ${fileName}`,
      promptLibrarySyncFailed: "外部提示词文件同步失败，请检查文件或取消同步。",
      promptLibrarySyncBlockedByDraft: "请先保存或取消当前编辑，再同步。",
      syncPromptLibraryNow: "立即同步",
      unlinkPromptLibrary: "取消同步",
  ...
  "en-US": {
    ...
    manager: {
      ...
      promptLibraryLocal: "Prompt library: using the app's internal copy",
      promptLibraryLinked: (fileName: string) => `Prompt library: linked to ${fileName}`,
      promptLibrarySyncFailed: "Could not sync the external prompt file. Check the file or unlink it.",
      promptLibrarySyncBlockedByDraft: "Save or cancel the current edit before syncing.",
      syncPromptLibraryNow: "Sync now",
      unlinkPromptLibrary: "Unlink",
