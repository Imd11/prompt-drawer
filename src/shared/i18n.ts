...
export const messages = {
  "zh-CN": {
    ...
    settings: {
      ...
      blacklistedAppsDescription: "在这些应用中隐藏 Piqory。",
    ...
    manager: {
      ...
      sendBehavior: "发送行为",
      sendBehaviorInherit: "继承设置",
      sendBehaviorPasteOnly: "只填入",
      sendBehaviorPasteEnter: "填入 + Enter",
      sendBehaviorPasteCommandEnter: "填入 + Cmd Enter",
    ...
    quickList: {
      ...
      noPromptsDescription: "打开 Piqory 创建第一个提示词。",
  ...
  "en-US": {
    ...
    settings: {
      ...
      subtitle: "Control how Piqory inserts prompts.",
      languageTitle: "Language",
      languageDescription: "Choose the language used by Piqory.",
      ...
      blacklistedAppsDescription: "Piqory stays hidden in these apps.",
    ...
    manager: {
      ...
      sendBehaviorInherit: "Use setting",
      sendBehaviorPasteOnly: "Insert only",
      sendBehaviorPasteEnter: "Insert + Enter",
      sendBehaviorPasteCommandEnter: "Insert + Cmd Enter",
    ...
    quickList: {
      ...
      noPromptsDescription: "Open Piqory to create your first prompt.",
