...
Prompt Drawer Codex, Cursor और CLI के लिए बनाया गया local desktop prompt library है। यह सक्रिय input के पास एक floating button रखता है, एक compact prompt picker खोलता है, और चुने हुए prompt को आपके काम की जगह पर insert करता है।
