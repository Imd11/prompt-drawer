...
![Prompt Drawer 演示](docs/prompt-drawer-demo.gif)

**阅读语言：** [English](README.md) | **简体中文** | [हिन्दी](README.hi.md) | [Español](README.es.md) | [العربية](README.ar.md)

每个人都值得拥有一个属于自己的提示词库。

Prompt Drawer 是一个面向 Codex、Cursor 和 CLI 的本地提示词库。直接从自己的提示词库中选择一条提示词，Prompt Drawer 就能自动填入当前输入框并发送，无需反复复制、粘贴和按回车。需要先检查内容时，也可以切换为“只填入”。
...
Prompt Drawer 在本地保存提示词库，不会把提示词内容上传到服务器。你可以随时导入或导出 JSON 提示词库，用于备份或迁移。
